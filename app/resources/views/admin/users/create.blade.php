        ...
        <form method="POST" action="{{ route('admin.users.store') }}" id="user-form">
            ...
            <div class="mb-3">
                ...
                <input type="password" name="password" id="password" placeholder="Contraseña"
                       class="w-full border rounded px-3 py-2" required minlength="8">
                @error('password')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="flex justify-end gap-2">
                ...
                <button type="submit" class="bg-green-300 text-black px-4 py-2 rounded hover:bg-green-400">Guardar</button>
            </div>
        </form>
    </div>
